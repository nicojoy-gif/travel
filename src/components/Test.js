...
function Test() {
  ...
  return (
    <div className='h-full lg:h-screen flex flex-col justify-center items-center '>
      <section className='grid lg:h-4/6 h-full grid-cols-1 container mx-auto lg:grid-cols-2 gap-6 items-center justify-center justify-items-center'>
        <div className='text-start'>
          <h2 className='uppercase text-gray-600 font-semibold'>Testimonials</h2>
          <h2 className='font-bold text-5xl lg:text-6xl'>What People Say <br />About Us.</h2>
        ...
        <div>
          <div className='relative justify-center justify-items-center align-middle items-center flex'>
            <div className='h-48 relative text-start text-slate-600 z-50 rounded-lg shadow-xl px-5 py-3'>
              <div className='absolute -top-9 left-0 rounded-full h-12 w-12'>
                <img src={cardsData[currentSlide].image} alt='Profile' className='rounded-full h-full w-full' />
              </div>
            ...
            {currentSlide !== cardsData.length - 1 && (
              <div className='absolute -bottom-16 lg:-bottom-16 w-[371px] lg:w-[420px] left-5 lg:left-10 h-24 lg:h-24 bg-white opacity-80 rounded-lg shadow-md'>
            ...
            <div className='flex flex-col space-y-6 mx-5 w-full'>
              <button onClick={goToPrevSlide}><FaChevronUp size={12} color='gray' /></button>
              <button onClick={goToNextSlide}><FaChevronDown size={12} color='gray' /></button>
            </div>
          </div>
        </div>
      </section>
      <section className='flex items-center container mx-auto justify-center space-x-24'>
